...
"Sólbakki", "Langholt", "Smáragrund", "Lautavegur", "Hólabrekka", "Hólabraut", "Hella", "Hólavegur", "Hamraborg", "Hólar", "Lautir", "Langholt", "Kjarni", "Laugabrekka", "Laugaskóli", "Gerði",
"Víðihlíð", "Hvítafell", "Birkifell", "Tröð", "Laugafell", "Selás", "Laugaból", "Breiðanes", "Hjalli","Laugaberg", "Stóru Laugar", "Lækjarás", "Laugagerði", "Öndólfsstaðir", "Akrar", "Halldórsstaðir",
"Hamrar", "Glaumbær", "Grundargil", "Kattholt", "Vallakot", "Einarsstaðir", "Hlíðarholt", "Jaðar", "Breiðamýri", "Kvígindisdalur", "Helgastaðir", "Pálmholt", "Hólkot", "Sýrnes", "Fagranes", "Fagraneskot",
"Helluland", "Norðurhlíð", "Grímshús", "Múli 1", "Fellsmúli", "Múli 2", "Kraunastaðir", "Aðalból", "Búvellir", "Grenjaðarstaður", "Hvoll", "Staðarhóll", "Staðarhraun", "Brúar", "Kasthvammur", "Árhvammur",
"Árhólar", "Þverá", "Auðnir", "Laxárvirkjun", "Presthvammur", "Brúnahlíð", "Klambrasel",
],
        gray_dates: [
